...
TEST(sphere_box_separated)
{
    ...
    m3d::tf tfB; tfB.pos = m3d::vec3(4.0, 0, 0);   // clearly separated
...
TEST(sphere_box_face_overlap_x)
{
    ...
    rbc::Shape bB = rbc::Box(m3d::vec3(1, 1, 1));
    m3d::tf tfA; tfA.pos = m3d::vec3(0, 0, 0);
    m3d::tf tfB; tfB.pos = m3d::vec3(1.8, 0, 0);   // sphere overlaps box face by 0.2
...
TEST(sphere_box_face_overlap_y)
{
    ...
    rbc::Shape bB = rbc::Box(m3d::vec3(1, 1, 1));
    m3d::tf tfA; tfA.pos = m3d::vec3(0,    0, 0);
    m3d::tf tfB; tfB.pos = m3d::vec3(0, 1.7, 0);   // overlap ≈ 0.3
    ...
    ASSERT_TRUE(hit_a);
    ASSERT_TRUE(hit_r);
    ASSERT_NEAR(analytic.penetration_depth, 0.3,                         0.05);
    ASSERT_NEAR(analytic.penetration_depth, reference.penetration_depth, 0.05);
...
TEST(sphere_box_corner_region_no_hit)
{
    ...
    rbc::Shape sA = rbc::Sphere(1.0);
    rbc::Shape bB = rbc::Box(m3d::vec3(1, 1, 1));
    m3d::tf tfA; tfA.pos = m3d::vec3(2, 2, 2);
...
TEST(sphere_box_corner_region_hit)
{
    ...
    rbc::Shape sA = rbc::Sphere(1.0);
    rbc::Shape bB = rbc::Box(m3d::vec3(1, 1, 1));
    m3d::tf tfA; tfA.pos = m3d::vec3(1.5, 1.5, 1.5);
    m3d::tf tfB; tfB.pos = m3d::vec3(0,   0,   0  );
    ...
    ASSERT_TRUE(hit);
    ASSERT_NEAR(c.penetration_depth, 1.0 - 0.866, 0.01);  // radius - dist_to_corner
...
TEST(sphere_box_centre_inside_box)
{
    ...
    m3d::tf tfA; tfA.pos = m3d::vec3(0.1, 0.1, 0.1);
    m3d::tf tfB; tfB.pos = m3d::vec3(0,   0,   0  );
...
TEST(box_sphere_symmetry)
{
    ...
    ASSERT_NEAR(c_sb.penetration_depth, c_bs.penetration_depth, 0.001);
